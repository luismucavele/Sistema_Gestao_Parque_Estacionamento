...
public class FuncionarioDAO {
    ...
    // Inserir funcionário
public void inserirFuncionario(int idFuncionario, String cargo, double salario, String usuario, String senha, boolean ativo, String documento, String telefone, String sexo, String email, String residencia) {  
    Connection conn = null;
    PreparedStatement stmt = null;
    try {
        conn = DBConnect.getConnection();  // Obtém conexão
        String sql = "INSERT INTO Funcionario (idFuncionario, cargo, salario, usuario, senha, ativo, documento, telefone, sexo, email, residencia) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
        ...
        stmt.setString(11, residencia);  // Adiciona o valor de 'residencia'
        stmt.executeUpdate();
